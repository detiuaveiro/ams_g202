            ...
            <td class="align-middle">
                <figure class="itemside align-items-center">
                    ...
                    <figcaption class="info">
                        <a href="#PRODUTO{product_id}" class="title text-dark sc-cart-item-name">{product_name}</a>
        ...
        _addUpdateCartItem: function (p) {
            ...
            if (!elmMain || elmMain.length === 0) {
                ...
                if(this.options.toolbarSettings.changeQuantity){
                    var quantitySelect = $('<select class="custom-select sc-cart-item-qty"></select>');
                } else{
                    var quantitySelect = $('<select class="custom-select sc-cart-item-qty" disabled></select>');
                }
